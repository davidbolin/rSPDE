...
- **David Bolin**. Maintainer, author.

- **Alexandre Simas**. Author.
...
David Bolin, Alexandre B. Simas, Zhen Xiong (2024), Covariance-based
rational approximations of fractional SPDEs for computationally
efficient Bayesian inference. Journal of Computational and Graphical
...
David Bolin, Kristin Kirchner (2020), The rational SPDE approach for
Gaussian random fields with general smoothness. Journal of Computational
and Graphical Statistics, 29:2, 274-285.
