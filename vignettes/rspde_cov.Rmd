...
the [R-INLA implementation of the rational SPDE approach](inla.html) vignette.
...
of the rational SPDE approach. For more details see the [R-INLA implementation of the rational SPDE approach](inla.html) vignette.
...
start_time <- Sys.time()
theta_parallel <- optimParallel(theta0, mlik_cov, obj=op_cov)
end_time <- Sys.time()
...
start_time <- Sys.time()
theta <- optimParallel(theta0, mlik_cov, obj = op_cov,
  method = "L-BFGS-B"
)
end_time <- Sys.time()
...
the usage of the [R-INLA implementation of the rational SPDE approach](inla.html).
...
start_time <- Sys.time()
pars <- optimParallel(theta0_2d, mlik_2d, obj = op_cov_2d)
end_time <- Sys.time()
