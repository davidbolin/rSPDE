...
# We need to pass "obj=op" as an argument because of the
# parallelization (this is not needed in the regular optim function)
start_time <- Sys.time()
pars <- optimParallel(theta0, mlik, obj=op)
end_time <- Sys.time()
