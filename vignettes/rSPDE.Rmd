...
```{r, fig.show='hold',fig.height = 7, fig.width = 7, fig.align = "center",echo=FALSE}
...
```{r plot_pred, fig.width=7.5, fig.height=7, echo=FALSE}
...
```{r plot_pred_sd, fig.width=7.5, fig.height=7, echo=FALSE}
...
```{r plot_pred2, fig.width=7.5, fig.height=7, echo=FALSE}
...
```{r plot_pred_sd2, fig.width=7.5, fig.height=7, echo=FALSE}
