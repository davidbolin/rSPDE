...
using the function `rspde_result()`:
...
```{r}
result_fit_rep <- rspde_result(rspde_fit.rep, "field", rspde_model.rep)
...
result_fit_2 <- rspde_result(rspde_fit_2, "field", rspde_model_2)
...
```{r}
result_fix <- rspde_result(rspde_fix, "field", rspde_model_fix)
summary(result_fix)
```
...
```{r}
rspde_result_int <- rspde_result(rspde_fix_int_1, "field", rspde_model_fix_int1)
...
```{r}
result_fit_beta <- rspde_result(rspde_fit_beta, "field", rspde_model_beta)
