...
locations to the mesh. To this end we will use the `spde.make.A()` helper function, which is a wrapper that uses the functions `fm_basis()`, `fm_block()` and `fm_row_block()` from the `fmesher` package.
