...
post_df_fit_order_3 <- gg_df(result_fit_order_3)

ggplot(post_df_fit_order_3) + geom_line(aes(x = x, y = y)) + 
facet_wrap(~parameter, scales = "free") + labs(y = "Density")
```
...
```{r fig.align = "center"}
posterior_df_fit_ln <- gg_df(result_fit_ln)

ggplot(posterior_df_fit_ln) + geom_line(aes(x = x, y = y)) + 
facet_wrap(~parameter, scales = "free") + labs(y = "Density")
```
