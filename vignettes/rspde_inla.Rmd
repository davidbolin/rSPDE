...
rspde_model <- rspde.matern(mesh = prmesh, parameterization = "matern", nu.upper.bound = 3,
...
rspde_model.rep <- rspde.matern(mesh = mesh_2d,
      parameterization = "matern", prior.theta.param = "theta",
      prior.nu.dist = "beta") 
```
...
By default, we assume that $\nu$ follows a truncated lognormal distribution.
...
```{r}
rspde_model_beta <- rspde.matern(mesh = prmesh, prior.nu.dist = "beta",
  nu.upper.bound = 2
)
```
