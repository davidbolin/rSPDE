---
title: "Operator-based rational approximation with the rSPDE package"
author: "David Bolin"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Operator-based rational approximation with the rSPDE package}
...
sample a 40 replicates of the latent field.
```{r}
n.rep = 30
...
mlik <- function(theta, Y, G, C, A) {
  return(-spde.matern.loglike(tau=exp(theta[1]), kappa=exp(theta[2]), nu=exp(theta[3]), sigma.e=exp(theta[4]),
