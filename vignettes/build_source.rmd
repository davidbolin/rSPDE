...
running the following command on `R`:
...
The `rSPDE` package depends on the [Eigen C++ library](https://eigen.tuxfamily.org/).
...
One should also confirm the location of the Eigen library. The
default location is `/usr/local/include/eigen3/` and is already set at the Makefile.
