...
We will now fit the same model as the one above using our `inlabru` implementation, however, we will now estimate nu. We need to create a `data.frame` with the response variables and locations:
