...
```{r}
s <- seq(from = 0, to = 100, length.out = 101)
t <- seq(from = 0, to = 50, length.out = 21)
```
...
op_1d_unbounded <- spacetime.operators(
  space_loc = df_1d$space, time_loc = df_1d$time,
  alpha = 1, beta = 1,
  bounded_rho = FALSE
)
...
st_bru_unbounded <- rspde.spacetime(
  space_loc = df_1d$space, time_loc = df_1d$time, alpha = 1,
