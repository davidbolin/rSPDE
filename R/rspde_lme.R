...
#' @param parameterization_latent The options are 'matern' and 'spde'. The 'matern' parameterizes as 'sigma' and 'range', whereas the 'spde' parameterization is given in terms of 'tau' and 'kappa'.
...
rspde_lme <- function(formula, data = NULL, 
                model = NULL, 
