...
through the SPDE \$\$(-\Delta)^{\beta/2} (\tau u) = \mathcal{W}\$\$
...
The covariance operator \$\$\tau^{-2}(-\Delta)^{\beta}\$\$ is
approximated based on a rational approximation. The Laplacian is
equipped with homogeneous Neumann boundary conditions and a zero-mean
