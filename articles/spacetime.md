...
#> 
#> Time used to:     fit the model =  22.4579 secs 
#>   set up the parallelization = 4.69491 secs
```
...
#> Optimization method used in 'optim' = L-BFGS-B
#> 
#> Time used to:     fit the model =  2.25585 mins 
#>   set up the parallelization = 5.09963 secs
```
