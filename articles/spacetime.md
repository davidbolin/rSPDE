...
#> 
#> Time used to:     fit the model =  24.29884 secs 
#>   set up the parallelization = 5.11368 secs
```
...
#> Optimization method used in 'optim' = L-BFGS-B
#> 
#> Time used to:     fit the model =  2.68995 mins 
#>   set up the parallelization = 5.62652 secs
```
