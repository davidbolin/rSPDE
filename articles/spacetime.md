...
#> 
#> Time used to:     fit the model =  24.19736 secs 
#>   set up the parallelization = 5.37202 secs
```
...
#> Optimization method used in 'optim' = L-BFGS-B
#> 
#> Time used to:     fit the model =  2.62588 mins 
#>   set up the parallelization = 5.80616 secs
```
