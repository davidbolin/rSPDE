...
#> 
#> Time used to:     fit the model =  24.3288 secs 
#>   set up the parallelization = 5.33285 secs
```
...
#> Optimization method used in 'optim' = L-BFGS-B
#> 
#> Time used to:     fit the model =  2.72446 mins 
#>   set up the parallelization = 5.72193 secs
```
