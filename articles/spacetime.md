...
#> 
#> Time used to:     fit the model =  23.63897 secs 
#>   set up the parallelization = 5.08761 secs
```
...
#> Optimization method used in 'optim' = L-BFGS-B
#> 
#> Time used to:     fit the model =  2.33583 mins 
#>   set up the parallelization = 5.49328 secs
```
