...
```
    ...
    ## 
    ## Time used to:     fit the model =  14.72182 secs
...
```
    ...
    ## Time difference of 14.72182 secs
...
```
    ...
    ## Optimization method used in 'optim' = L-BFGS-B
    ## 
    ## Time used to:     fit the model =  8.12175 secs 
    ##   set up the parallelization = 2.55535 secs
...
```
    ...
    ## Time difference of 10.67711 secs
...
```
    ...
    ## Optimization method used in 'optim' = L-BFGS-B
    ## 
    ## Time used to:     fit the model =  13.23829 secs 
    ##   set up the parallelization = 2.59804 secs
...
```
    ...
    ## Time difference of 13.2383 secs
...
```
    ...
    ## Optimization method used in 'optim' = L-BFGS-B
    ## 
    ## Time used to:     fit the model =  10.86158 secs 
    ##   compute the Hessian = 6.25641 secs 
    ##   set up the parallelization = 2.68556 secs
...
```
    ...
    ## Optimization method used in 'optim' = L-BFGS-B
    ## 
    ## Time used to:     fit the model =  2.74477 mins 
    ##   set up the parallelization = 2.54356 secs
...
```
    ...
    ## Time difference of 2.744777 mins
...
```
    ...
    ## Optimization method used in 'optim' = L-BFGS-B
    ## 
    ## Time used to:     fit the model =  15.73458 secs 
    ##   set up the parallelization = 2.58938 secs
...
```
    ...
    ## 
    ## Time used to:     fit the model =  2.49304 mins
...
```
    ...
    ## Optimization method used in 'optim' = L-BFGS-B
    ## 
    ## Time used to:     fit the model =  11.20812 secs 
    ##   set up the parallelization = 2.72641 secs
...
```
    ...
    ## Optimization method used in 'optim' = L-BFGS-B
    ## 
    ## Time used to:     fit the model =  12.26717 secs 
    ##   set up the parallelization = 2.7401 secs
...
```
    ...
    ## Optimization method used in 'optim' = L-BFGS-B
    ## 
    ## Time used to:     fit the model =  9.71207 secs 
    ##   set up the parallelization = 2.71736 secs
...
```
    ...
    ## Optimization method used in 'optim' = L-BFGS-B
    ## 
    ## Time used to:     fit the model =  17.59408 secs 
    ##   set up the parallelization = 2.70212 secs
...
```
    ...
    ## Optimization method used in 'optim' = L-BFGS-B
    ## 
    ## Time used to:     fit the model =  49.84232 secs 
    ##   set up the parallelization = 2.53424 secs
...
```
    ...
    ## Optimization method used in 'optim' = L-BFGS-B
    ## 
    ## Time used to:     fit the model =  56.23474 secs 
    ##   set up the parallelization = 2.55691 secs
