...
summary(rspde_fit)
#> Time used:
#>     Pre = 0.327, Running = 2.29, Post = 0.042, Total = 2.66 
#> Random effects:
#>   Name     Model
#>     field CGeneric
#> 
...
#> Time used:
#>     Pre = 0.148, Running = 2.39, Post = 0.157, Total = 2.7 
#> Random effects:
#>   Name     Model
#>     field CGeneric
#> 
...
#> 
#> Time used to:     fit the model =  48.8385 secs 
#>   set up the parallelization = 2.66787 secs
```
...
#> Time difference of 48.8385 secs
```
