...
summary(rspde_fit)
#> Time used:
#>     Pre = 0.32, Running = 2.14, Post = 0.0404, Total = 2.5 
#> Random effects:
#>   Name     Model
#>     field CGeneric
#> 
...
#> Time used:
#>     Pre = 0.15, Running = 2.18, Post = 0.124, Total = 2.45 
#> Random effects:
#>   Name     Model
#>     field CGeneric
#> 
...
#> 
#> Time used to:     fit the model =  47.10495 secs 
#>   set up the parallelization = 2.63807 secs
```
...
#> Time difference of 47.10496 secs
```
