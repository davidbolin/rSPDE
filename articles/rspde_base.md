...
#> 
#> Time used to:     fit the model =  1.25447 mins 
#>   set up the parallelization = 2.6526 secs
```
...
#> Time difference of 1.254472 mins
```
...
#> Optimization method used in 'optim' = L-BFGS-B
#> 
#> Time used to:     fit the model =  1.21149 mins 
#>   set up the parallelization = 2.60545 secs
```
...
# Total time
print(fit_2d$fitting_time)
#> Time difference of 1.211495 mins
```
